...
public:
  ...
  static std::size_t mapIndex(const std::size_t row, const std::size_t col) {
    return 4 * row + col;
  }
  ...
  Vector operator*(Vector const &rhs) const {
    float v1 = data[mapIndex(0, 0)] * rhs.data[0] +
               data[mapIndex(0, 1)] * rhs.data[1] +
               data[mapIndex(0, 2)] * rhs.data[2] +
               data[mapIndex(0, 3)] * rhs.data[3];
    float v2 = data[mapIndex(1, 0)] * rhs.data[0] +
               data[mapIndex(1, 1)] * rhs.data[1] +
               data[mapIndex(1, 2)] * rhs.data[2] +
               data[mapIndex(1, 3)] * rhs.data[3];
    float v3 = data[mapIndex(2, 0)] * rhs.data[0] +
               data[mapIndex(2, 1)] * rhs.data[1] +
               data[mapIndex(2, 2)] * rhs.data[2] +
               data[mapIndex(2, 3)] * rhs.data[3];
    float v4 = data[mapIndex(3, 0)] * rhs.data[0] +
               data[mapIndex(3, 1)] * rhs.data[1] +
               data[mapIndex(3, 2)] * rhs.data[2] +
               data[mapIndex(3, 3)] * rhs.data[3];
