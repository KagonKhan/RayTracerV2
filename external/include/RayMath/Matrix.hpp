...
public:
  ...
  Vector operator*(Vector const &rhs) const {
    const float v1 =
        data[mapIndex(0, 0)] * rhs.x + data[mapIndex(0, 1)] * rhs.y +
        data[mapIndex(0, 2)] * rhs.z + data[mapIndex(0, 3)] * rhs.w;
    const float v2 =
        data[mapIndex(1, 0)] * rhs.x + data[mapIndex(1, 1)] * rhs.y +
        data[mapIndex(1, 2)] * rhs.z + data[mapIndex(1, 3)] * rhs.w;
    const float v3 =
        data[mapIndex(2, 0)] * rhs.x + data[mapIndex(2, 1)] * rhs.y +
        data[mapIndex(2, 2)] * rhs.z + data[mapIndex(2, 3)] * rhs.w;
    const float v4 =
        data[mapIndex(3, 0)] * rhs.x + data[mapIndex(3, 1)] * rhs.y +
